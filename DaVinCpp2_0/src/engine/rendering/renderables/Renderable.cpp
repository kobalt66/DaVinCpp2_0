...
: Component(ComponentType::SURFACE)
, m_Position(position)
, m_Color(color)
{
}
...
glm::vec4 Renderable::mapTextureByUVCoords(
    std::shared_ptr<Texture2D> texture, int pixelX, int pixelY, float width, float height) const
{
