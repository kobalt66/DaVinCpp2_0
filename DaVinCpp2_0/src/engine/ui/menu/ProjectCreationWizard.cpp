...
{
	try {
		return {getMenuElementByTag<SelectFilepathButton>(PROJECT_NAME)->getFilePath(),
		        {
		            {},
		            {},
		            ...
		            glm::uvec2(getMenuElementByTag<NumberFieldElement>(PROJECT_RESOLUTION_WIDTH)->getValue(),
		                       getMenuElementByTag<NumberFieldElement>(PROJECT_RESOLUTION_HEIGHT)->getValue()),
		            glm::uvec2(getMenuElementByTag<NumberFieldElement>(PROJECT_PIXEL_WIDTH)->getValue(),
