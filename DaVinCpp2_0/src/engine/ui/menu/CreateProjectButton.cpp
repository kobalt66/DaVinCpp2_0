...
{
    std::shared_ptr<ProjectCreationWizard> projectCreationWizard
        = selectionMenu->getMenuPage<ProjectCreationWizard>(SelectionMenu::PAGE_CREATE_PROJECT);
    std::pair<std::filesystem::path, ProjectConfig> projectData
        = projectCreationWizard->castProjectData();
...
ProjectConfig CreateProjectButton::getProject() const { return m_ProjectConfig; }
