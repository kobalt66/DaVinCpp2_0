...
{
  public:
	explicit PageElement(const std::string& displayText, std::string_view pagePointer = SelectionMenu::PAGE_UNDEFINED,
	                     bool gotoPreviousPage = false, const std::string& uniqueTag = "");
