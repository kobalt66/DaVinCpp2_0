...
namespace davincpp {
SelectProjectButton::SelectProjectButton(const std::string& displayText,
                                         ProjectConfig&     projectConfig,
                                         int                projectIdx,
                                         const std::string& uniqueTag)
    : MenuElement(displayText, uniqueTag), m_TargetProjectConfig(projectConfig),
...
void SelectProjectButton::onInteraction(SelectionMenu* selectionMenu) {
    ...
    SelectionMenu::displayDescription(
        Console::fmtTxt("Switched DaVinCpp Project to '",
                        m_TargetProjectConfig.ProjectName, "'... "),
