...
void TextElement::onRender(bool selected)
{
	...
	switch (m_Align) {
	case ALIGN_LEFT:
		Console::printTextMarginL(m_DisplayText, selected ? Console::BLACK_GREEN_PAIR : Console::GREEN_BLACK_PAIR,
		                          m_CliY, m_Margin);
		break;
	case ALIGN_MIDDLE:
		Console::printCenteredText(m_DisplayText, selected ? Console::BLACK_GREEN_PAIR : Console::GREEN_BLACK_PAIR,
		                           m_CliY);
		break;
	case ALIGN_RIGHT:
		Console::printTextMarginR(m_DisplayText, selected ? Console::BLACK_GREEN_PAIR : Console::GREEN_BLACK_PAIR,
		                          m_CliY, m_Margin);
		break;
	}
#endif
