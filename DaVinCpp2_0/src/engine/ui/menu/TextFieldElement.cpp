...
namespace davincpp
{
TextFieldElement::TextFieldElement(const std::string& displayText,
...
void TextFieldElement::onSwitchPage(SelectionMenu* selectionMenu) { m_EnteredText.clear(); }
...
void TextFieldElement::onUpdate(SelectionMenu* selectionMenu, int input)
{
    ...
    {
        SelectionMenu::displayDescription(Console::fmtTxt("You've reached the character limit of ",
                                                          m_CharacterLimit,
                                                          " characters! "),
...
std::string TextFieldElement::getEnteredText() const { return m_EnteredText; }
}  // namespace davincpp
