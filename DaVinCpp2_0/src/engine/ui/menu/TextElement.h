...
namespace davincpp {
enum TextAlign { ALIGN_LEFT, ALIGN_MIDDLE, ALIGN_RIGHT };

class TextElement : public MenuElement {
  public:
    explicit TextElement(const std::string& displayText, bool skipable = true,
                         TextAlign align = ALIGN_MIDDLE, int margin = 1);
