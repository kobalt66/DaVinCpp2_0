...
namespace davincpp
{
ScrollSelectionElement::ScrollSelectionElement(const std::string&              displayText,
...
void ScrollSelectionElement::onSwitchPage(SelectionMenu* selectionMenu) { m_SelectedOption = 0; }
