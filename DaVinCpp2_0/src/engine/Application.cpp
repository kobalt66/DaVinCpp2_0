...
void Application::onStartEngine()
{
	...
	ASSERT_ENGINE_CALL(m_ProjectManager = std::make_shared<ProjectManager>("[TEST_ENV]/davincpp.yaml"),
...
void Application::onLoad()
{
	...
	// square3->setComponent(new Square(glm::vec2(10, 59), glm::vec4(100.0f, 12.0f, 43.0f, 200.0f), 10.0f, 10.0f,
	// true)); m_GameObjectManager->registerGameObject(square3);
	//
