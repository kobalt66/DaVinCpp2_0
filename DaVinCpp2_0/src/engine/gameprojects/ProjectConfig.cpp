...
{
    rhs.DaVinCppVersion
        = davincpp::DaVinCppYamlHelper::getValue<std::string>(node, "davincppVersion");
    ...
    rhs.PixelSize = davincpp::DaVinCppYamlHelper::getValue(
        node,
        "pixelSize",
        glm::uvec2(davincpp::DEFAULT_PIXEL_SIZEX, davincpp::DEFAULT_PIXEL_SIZEY));
    rhs.ScreenResolution = davincpp::DaVinCppYamlHelper::getValue(
        node,
        "resolution",
        glm::uvec2(davincpp::DEFAULT_RESOLUTION_WIDTH, davincpp::DEFAULT_RESOLUTION_HEIGHT));

    rhs.ScriptFiles = davincpp::DaVinCppYamlHelper::getSequence<davincpp::davscript::DavScript>(
        node, "scripts");
    rhs.TextureFiles
        = davincpp::DaVinCppYamlHelper::getSequence<std::filesystem::path>(node, "textures");
    ...
    rhs.FlipTexturesH
        = davincpp::DaVinCppYamlHelper::getValue(node, "flipTexturesH", rhs.FlipTexturesH);
