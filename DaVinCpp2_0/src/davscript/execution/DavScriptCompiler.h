...
{
  public:
	DavScriptCompiler(std::shared_ptr<Ast> ast, const std::vector<IdentifierNode>& usedNamespaces,
  ...
  private:
	...
	std::unordered_map<uint32_t, std::pair<std::string, std::function<void(DavScriptVirtualMachine*)>>>
