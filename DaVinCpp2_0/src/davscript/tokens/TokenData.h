...
static const std::unordered_map<char, TokenType> SINGLE_CHAR_TOKENS = {
    {T_COMMA, COMMA},     {T_DOT, DOT},         {T_COLON, COLON},   {T_LPARAN, LPARAN}, {T_RPARAN, RPARAN},
    {T_LBRAKET, LBRAKET}, {T_RBRAKET, RBRAKET}, {T_LCURLY, LCURLY}, {T_RCURLY, RCURLY}, {T_NEWLINE, NEWLINE},
};
...
static const std::unordered_map<std::string, TokenType> VARIABLE_TYPE_TOKENS = {
    {T_REF, REF}, {T_VAR, VAR}, {T_PARAM, PARAM}, {T_CONST, CONST}, {T_REFCOMP, REFCOMP}, {T_ARRAY, ARRAY},
};
...
static const std::unordered_map<SymbolType, std::string> SYMBOL_TYPE2STRING = {
    {SymbolType::VARIABLE, "variable"}, {SymbolType::PARAMETER, "parameter"}, {SymbolType::CONSTANT, "constant"},
    {SymbolType::FUNCTION, "function"}, {SymbolType::STRUCT, "struct"},
};
} // namespace davincpp::davscript