...
public:
    ...
    static std::string generateDuplicateSymbolNameError(const Token& symbolToken,
                                                        SymbolType   symbolType);
    static std::string generateInvalidModuleNamespaceError(const Token& moduleNameToken);

    static std::string generateCompilerErrorInvalidValueType(const Token& typeToken,
    ...
    static std::string generateRuntimeErrorInvalidPointerAccess(uint32_t         ptr,
                                                                std::string_view context);
    static std::string generateRuntimeErrorInvalidStackAccessEmptyStack();
    static std::string generateRuntimeErrorInvalidParameterValue(std::string_view functionName,
                                                                 int              parameterIndex,
