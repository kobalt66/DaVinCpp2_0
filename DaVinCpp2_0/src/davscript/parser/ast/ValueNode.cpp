...
namespace davincpp::davscript
{
    ...
    Token ValueNode::getValueType() const
    {
        ...
        switch (m_Value.getTokenType()) {
            case NUMBERINT:     valueType.setTokenType(INTTYPE); break;
            case NUMBERFLOAT:   valueType.setTokenType(FLOATTYPE); break;
            case STRING:        valueType.setTokenType(STRINGTYPE); break;
            case TRUE:
            case FALSE:         valueType.setTokenType(BOOLTYPE); break;
            default:            valueType.setTokenType(MIXEDTYPE); break;
        }
