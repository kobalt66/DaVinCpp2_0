...
{
AssignmentNode::AssignmentNode(Token                          variableType,
                               Token                          identifier,
...
bool AssignmentNode::operator==(const AstNode& other) const
{
    ...
    return m_VariableType == otherNode->m_VariableType && m_Identifier == otherNode->m_Identifier
...
std::shared_ptr<ValueTypeNode> AssignmentNode::getType() const { return m_Type; }
