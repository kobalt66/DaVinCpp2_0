                                      ...
                                      const Token&     expectedValueType)
{
    ...
    switch (expectedValueType.getTokenType())
    {
        ...
        case BOOLTYPE:
            expectedTokenType
                = tokenValueType != TRUE && tokenValueType != FALSE ? BOOLTYPE : expectedTokenType;
            break;
        case MIXEDTYPE:
            return true;
        default:
...
bool BaseNodeParser::assertSymbolAccess(DavScriptParser*                       scriptParser,
...
bool BaseNodeParser::assertSymbolNoAccess(DavScriptParser*                       scriptParser,
                                          const std::shared_ptr<IdentifierNode>& identifierNode,
                                          SymbolType                             symbolType)
{
    if (!scriptParser->validateSymbol(identifierNode, symbolType))
...
{
    return std::ranges::any_of(symbolTypes.begin(),
                               symbolTypes.end(),
...
bool BaseNodeParser::assertSymbolDoesntExist(DavScriptParser*                       scriptParser,
                                             const std::shared_ptr<IdentifierNode>& identifierNode,
                                             SymbolType                             symbolType)
{
