...
bool BaseNodeParser::assertTokenRole(DavScriptParser* scriptParser, const Token& actualToken,
...
bool BaseNodeParser::assertNotTokenRole(DavScriptParser* scriptParser, const Token& actualToken,
                                        const Token& expectedToken)
{
	if (!checkTokenRole(actualToken, expectedToken)) {
		return true;
...
bool BaseNodeParser::assertTokenType(DavScriptParser* scriptParser, const Token& actualToken,
                                     const Token& expectedToken)
{
...
bool BaseNodeParser::assertNotTokenType(DavScriptParser* scriptParser, const Token& actualToken,
                                        const Token& expectedToken)
{
...
bool BaseNodeParser::assertSymbolAccess(DavScriptParser* scriptParser,
                                        const std::shared_ptr<IdentifierNode>& identifierNode, SymbolType symbolType)
{
...
{
	return std::ranges::any_of(symbolTypes.begin(), symbolTypes.end(),
