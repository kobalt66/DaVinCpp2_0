...
{
  public:
	explicit DavScriptParser(DavScript scriptFile, const std::vector<Token>& tokens, bool root = true);
  ...
  private:
	[[nodiscard]] static DavScriptNamespace parseUsedScriptFile(const IdentifierNode& namespaceName);
