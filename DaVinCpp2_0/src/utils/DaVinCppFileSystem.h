...
class DaVinCppFileSystem
{
  public:
	...
	static std::pair<std::vector<std::filesystem::directory_entry>, std::vector<std::filesystem::directory_entry>>
	getContentsOfDirectory(const std::filesystem::path& directoryPath);
	static std::vector<std::filesystem::directory_entry> getFilesInDirectoryRecursive(
