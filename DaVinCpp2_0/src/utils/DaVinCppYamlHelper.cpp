...
template std::vector<davscript::DavScript> DaVinCppYamlHelper::getSequence(const YAML::Node& node,
                                                                           std::string_view nodeName);
template std::vector<std::filesystem::path> DaVinCppYamlHelper::getSequence(const YAML::Node& node,
                                                                            std::string_view nodeName);
...
template glm::uvec2 DaVinCppYamlHelper::getValue(const YAML::Node& node, std::string_view nodeName,
                                                 glm::uvec2 _default);
} // namespace davincpp
