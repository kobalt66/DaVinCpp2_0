...
std::string DaVinCppString::findReplaceAllByRegex(std::string_view input, const std::regex& regex,
...
std::string DaVinCppString::fmtTime(msc duration)
{
	...
	oss << std::setfill('0') << std::setw(2) << minutes.count() << ":" << std::setfill('0') << std::setw(2)
	    << seconds.count() << "." << std::setfill('0') << std::setw(2) << milliseconds.count();
