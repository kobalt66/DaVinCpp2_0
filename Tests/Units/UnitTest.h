...
class UnitTest {
  ...
  protected:
    ...
    void
    expectException(const std::filesystem::path& expectedExceptionTranscript);
...
#define assertTrue(expression)                                                 \
    if (!(expression)) {                                                       \
        ...
        throw davincpp::system_error(davincpp::Console::fmtTxt(                \
            ...
            "'",                                                               \
            #expression, "' was ", expression ? "true" : "false",              \
...
#define assertEquals(expected, actual)                                         \
    if ((expected) != (actual)) {                                              \
        DEBUG_BREAK;                                                           \
        throw davincpp::system_error(davincpp::Console::fmtTxt(                \
            "Failed to assert that '", actual, "' equals '", expected,         \
            "'! \nFailed assertion at (", __FILE__, ":", __LINE__, ")"));      \
    }
...
#define assertGreaterThan(actual, number)                                      \
    if ((actual) <= (number)) {                                                \
        DEBUG_BREAK;                                                           \
        throw davincpp::system_error(davincpp::Console::fmtTxt(                \
            "Failed to assert that '", actual, "' is greater than '", number,  \
            "'! \nFailed assertion at (", __FILE__, ":", __LINE__, ")"));      \
    }
...
#define assertLessThan(actual, number)                                         \
    if ((actual) >= (number)) {                                                \
        DEBUG_BREAK;                                                           \
        throw davincpp::system_error(davincpp::Console::fmtTxt(                \
            "Failed to assert that '", actual, "' is less than '", number,     \
            "'! \nFailed assertion at (", __FILE__, ":", __LINE__, ")"));      \
    }
...
#define assertGreaterEqualsThan(actual, number)                                \
    if ((actual) < (number)) {                                                 \
        DEBUG_BREAK;                                                           \
        throw davincpp::system_error(davincpp::Console::fmtTxt(                \
            "Failed to assert that '", actual, "' is greater or equal than '", \
            number, "'! \nFailed assertion at (", __FILE__, ":", __LINE__,     \
            ")"));                                                             \
    }
...
#define assertLessEqualsThan(actual, number)                                   \
    if ((actual) > (number)) {                                                 \
        DEBUG_BREAK;                                                           \
        throw davincpp::system_error(davincpp::Console::fmtTxt(                \
            "Failed to assert that '", actual, "' is less or equal than '",    \
            number, "'! \nFailed assertion at (", __FILE__, ":", __LINE__,     \
            ")"));                                                             \
    }
...
#define assertGetException(expression, errorMsg)                               \
    {                                                                          \
        ...
        if (!thrownException) {                                                \
            DEBUG_BREAK;                                                       \
            throw davincpp::system_error(davincpp::Console::fmtTxt(            \
                "Failed to assert that '", #expression,                        \
                "' will throw the following exception: '", errorMsg,           \
                "'! \nFailed assertion at (", __FILE__, ":", __LINE__, ")"));  \
        }                                                                      \
    }
} // namespace davincpp::unittest
